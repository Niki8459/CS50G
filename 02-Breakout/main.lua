...
--[[
    Called just once at the beginning of the game; used to set up game
    objects, variables, etc. and prepare the game world.
]]
function love.load()
    -- set love's default filter to "nearest-neighbor", which essentially
    -- means there will be no filtering of pixels (blurriness), which is
    -- important for a nice crips, 2D look
    ...
    -- 6. 'game-over' (the player has lostl display score and allow restart)
    ...
    -- frame, to get around the fact the LOVE's default callback won't let us
...
function love.keypressed(key)
    -- add to pur table of keys pressed this frame
...
function love.draw()
    ...
    -- display FPS for debugging; simply comment out to remove it
    displayFPS()
...
--[[
    Loads high scores from a .lst file, saved in LOVE2D's default save directory in a subfolder
    called 'breakout'.
]]
