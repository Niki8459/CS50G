...
-- a basic StateMachine which will allow us to transition to and from
-- game states smoothly and avoid monoluthic code in one file
require 'src/StateMachine'

-- utility functions, mainly for the splitting our sprite sheet into various Quads
