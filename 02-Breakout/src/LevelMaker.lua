...
--[[
    Creates a tabale of Bricks to be returned to the main game, with different
        ...
        for x = 1, numCols do
            b = Brick(
                ...
                * 32                   -- multiply by 32, the brick width
                + 8                    -- the screen should have 8 pixels of paddingl we can fit 13 cols + 16 pixels total
