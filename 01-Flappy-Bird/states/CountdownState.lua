--[[
    ...
    game is about to begin. Transitions to the PlayState as soon as the countdown
    is complete.
]]
...
--[[
    ...
    exceeded our countdown time. If we have gone down to 0, we should transition
    to our PlayState.
]]
