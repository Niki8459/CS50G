...
function love.draw()
   push:start()
    ...
    -- here, we draw our images shifted to the left by their looping point; 
    -- eventually, they will revert back to 0 once a certain distance has elapsed, 
    -- which will make it seem as if the are infinitely scrolling. 
    -- Choosing a looping point that is seamless is key, so as to provide the 
    -- illusion of looping
