--[[
    ...
    Release by Rovio in 2009, Angry Birds took the mobile gaming scene by storm back
...
function love.draw()
    ...
    -- draw a polygon shape by gettingthe world points for our body, using the box shape's
