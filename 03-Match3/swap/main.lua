...
function love.load()
    ...
    highlightedX, hightlightedY = 1, 1
    ...
    for y = 1, 8 do
        ...
        for x = 1, 8 do
            ...
            table.insert(tiles[y], {
                    ...
                    -- coordinates are 0-based, so abstract one before multiplying by 32
                    x = (x - 1) * 32,
                    y = (y - 1) * 32,
...
function drawBoard(offsetX, offsetY)
        ...
        for x = 1, 8 do
            ...
            if highlightedTile then
                if tile.gridX == highlightedX and tile.gridY == highlightedY then
                    ...
                    -- rounder rectangle with the 4 at the end (corner segments)
    ...
    love.graphics.setColor(1, 0, 0, 0.92)
